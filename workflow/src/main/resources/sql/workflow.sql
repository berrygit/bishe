...
CREATE TABLE `WORKFLOW_INSTANCE_BACKUP` (
  ...
  `GMT_UPDATE` varchar(64) DEFAULT NULL COMMENT '实例执行更新时间',
...
CREATE TABLE `SERVICE_STATE` (
	...
	`AVERAGE_TIME_COST` bigint(16) DEFAULT 0 COMMENT '最大消耗时间',
	`MIN_TIME_COST` bigint(16) DEFAULT 0 COMMENT '最大消耗时间',
	PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;